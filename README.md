...
and and all remaining words are considered arguments to that command. hsh then proceeds with the following actions:
...
After receiving a command, hsh tokenizes it into words using " " as a delimiter. The first word is considered the comm
...
?? SEGUN OLAWALE
    ...
    GitHub: @Olawalesegun
    Twitter: @Motai_tk
    LinkedIn: https://www.linkedin.com/in/segun-nuhu-olawale-977a4b19a/
